  ...
  return (
    <Sidebar>
      <SidebarContent>
        ...
        {/* Room Members */}
        <div className="p-4 border-b">
          <div className="flex items-center text-sm cursor-pointer space-x-2" onClick={() => setShowMembers(!showMembers)}>
        ...
        {/* Pending Requests */}
        <div className="p-4 border-b">
          <div className="flex items-center text-sm cursor-pointer space-x-2" onClick={() => setShowRequests(!showRequests)}>
